...
import {
  LayoutDashboard, Briefcase, ArrowRightLeft, LineChart, BellRing,
  ...
  return (
    <header className="h-16 border-b border-border bg-card/50 backdrop-blur-md flex items-center justify-between px-4 md:px-6 sticky top-0 z-10">
      <div className="flex items-center gap-4">
        {/* Mobile wordmark */}
        <div className="flex items-center gap-2 text-primary font-bold text-lg tracking-tight md:hidden">
